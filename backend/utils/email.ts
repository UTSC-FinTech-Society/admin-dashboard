...
export const memberEmailTemplate = (name: string) => {
    return `
        ...
        FinTech industry.
        <br><br>
        Discord Link: <a href='https://discord.gg/mQSswsFzuy'>https://discord.gg/mQSswsFzuy</a>
        <br><br>
        Sincerely,<br>
...
const sendEmail = (to: string, subject: string, html: string) => {
    ...
    transporter.sendMail(mailOptions, (error, info) => {
        if (error) {
            ...
            console.info(`[nodemailer]: Email <to: ${mailOptions.to}, subject: ${mailOptions.subject}> sent: ${info.response}`);
        }
    });
};
